...
This project is currently in a pre-CRAN development phase and only available from this GitHub repository. To install it, make sure that you have the `devtools` package installed (this comes bundled with RStudio), and then execute the following on the R command line:
