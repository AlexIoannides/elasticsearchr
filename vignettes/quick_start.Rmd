...
The latest (development) version of this package is available from [this GitHub repository][githubrepo]. To install it, make sure that you have the `devtools` package installed (this comes bundled with RStudio), and then execute the following on the R command line:
